...
const EMOJI_NAMES: Record<string, string> = {
  ...
  "🧟": "zombie monster undead horror",
  "💹": "chart increasing yen market stocks finance",
  "🗂️": "card index dividers organize files folders",
  "📄": "page document file paper",
  "📃": "page curl document file",
  "📑": "bookmark tabs document pages",
  "📕": "closed book red read",
  "📗": "closed book green read",
  "📘": "closed book blue read",
  "📙": "closed book orange read",
  ...
  "⚔️": "crossed swords battle fight combat",
  "🔱": "trident emblem anchor fork",
  "🚔": "police car siren emergency cop",
  "🔍": "magnifying glass search left tilt",
  "🔎": "magnifying glass search right tilt",
  "🔗": "link chain url hyperlink connect",
  "⛓️": "chains link metal locked",
  "🪝": "hook hang catch fishing",
  "🪤": "mouse trap bait catch pest",
  "📰": "newspaper news press article",
  "🗞️": "rolled up newspaper news press",
  "💼": "briefcase business work office job",
  "🗳️": "ballot box vote election poll",
}
